...
def test_transition_state_cerjan_miller_surface(optimizer, atol=1e-2):
...
@pytest.mark.parametrize("optimizer", [RFO, PRFO])
def test_transition_state_adams_surface(optimizer, atol=1e-2):
...
@pytest.mark.parametrize("optimizer", [RFO, PRFO])
def test_transition_state_mueller_brown_surface(optimizer, atol=1e-2):
...
@pytest.mark.parametrize("optimizer", [RFO, PRFO])
def test_second_order_saddle_point(optimizer, atol=1e-2):
...
@pytest.mark.parametrize("optimizer", [RFO, PRFO])
def test_transition_state_ammonia(optimizer):
...
@pytest.mark.parametrize("optimizer", [RFO, PRFO])
def test_transition_state_ethane(optimizer):
